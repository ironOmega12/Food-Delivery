...
public class CartAdapter extends RecyclerView.Adapter<CartAdapter.viewholder> {
    ...
    public void onBindViewHolder(@NonNull CartAdapter.viewholder holder, int position) {
        ...
        holder.tvaEachItem.setText("RON"+(list.get(position).getNumberInCart()*list.get(position).getPrice()));
        holder.totalEachItem.setText(list.get(position).getNumberInCart()+" x RON"+(
    ...
    public class viewholder extends RecyclerView.ViewHolder{
        TextView title, tvaEachItem, plusItem, minusItem;
        ImageView pic;
        ...
        public viewholder(@NonNull View itemView) {
            ...
            tvaEachItem = itemView.findViewById(R.id.tvaEachItem);
