...
public class MainActivity extends BaseActivity {
    ...
    private void initWelcomeName() {
        FirebaseUser user = FirebaseAuth.getInstance().getCurrentUser();
        String userEmail = user.getEmail();
        String userName = userEmail.split("@")[0];
        String firstLetter = userName.substring(0, 1).toUpperCase();
        String userNameCap = firstLetter + userName.substring(1);
        binding.textView7.setText(userNameCap);
    ...
    private void setVariable() {
        ...
        binding.searchBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String text = binding.editTextText.getText().toString(); //pt search-field / nu mai merge sa-l editez fara erori;
                if(!text.isEmpty()){
        ...
        binding.addItemAdminBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(MainActivity.this, AddFoodsActivity.class));
            }
        });
    }
